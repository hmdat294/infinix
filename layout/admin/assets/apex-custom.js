$(function () {
	...
	// 		width: 5
	// 	},
	// 	colors: ["#5283FF", '#F1C40F', '#FF4C92'],
	// 	series: [{
	// 		name: "User",
	// 		data: [45, 30, 56, 20, 33, 27]
	// 	}, {
	// 		name: "Post",
	// 		data: [1, 20, 30, 25, 40, 50]
	// 	}, {
	// 		name: "React",
	...
	var optionsLine = {
		...
		colors: ["#5283FF", '#F1C40F', '#FF4C92'], // Xanh cho Users, Vàng cho Post, Hồng cho React
		series: [{
			name: "Users",
	...
	var options = {
		...
		colors: ["#ffc107", "#0d6efd", "#17a00e", "#f41127"], // Màu sắc tương ứng: Vàng, Xanh, Xanh lá, Hồng
		labels: ['User report', 'Comment report', 'Post report', 'Group report'], // Nhãn cho từng loại report
		responsive: [{
			breakpoint: 480,
			options: {
				chart: {
